import { _ as __vitePreload } from './assets/preload-helper-CFRRcouo.js';
...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/_virtual_mf-localSharedImportMap___mfe_internal__inventory-DOdYZOHQ.js'),true?[]:void 0))
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-BqiQFESU.js'),true?[]:void 0))
