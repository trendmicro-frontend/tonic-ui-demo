import { _ as __vitePreload } from './assets/preload-helper-Ri8ahlGb.js';
...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/_virtual_mf-localSharedImportMap___mfe_internal__widget_updates-B-gQbqOd.js'),true?[]:void 0))
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-CSbQcEIK.js'),true?[]:void 0))
