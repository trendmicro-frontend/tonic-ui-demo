...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  if (__mfShareKey.startsWith("default:")) {
    ...
    function __mfCreateDeferredRemoteProxy() {
      ...
      const getModule = () => __mfModuleCache.remote["widget_os/main"];
    ...
    let exportModule = __mfModuleCache.remote["widget_os/main"];
...
const virtual_mf___mfe_internal__mfe_shell__loadRemote__widget_os_mf_1_main__loadRemote__ = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  __mf_remote_pending,
  get default () { return __mfDefaultExport; }
}, [exportModule]);

export { virtual_mf___mfe_internal__mfe_shell__loadRemote__widget_os_mf_1_main__loadRemote__ as v };
