import { _ as __vitePreload } from './assets/preload-helper-D7GtZJkZ.js';
...
const __mfResolveGlobalKey = "__mf_init__virtual:mf:__mfe_internal__inventory__mf_v__runtimeInit__mf_v__.js__";
...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/_virtual_mf-localSharedImportMap___mfe_internal__inventory-C0OsSSm1.js'),true              ?[]:void 0))
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-L6SpoLF2.js'),true              ?[]:void 0))
  ...
  async function init(shared = {}, initScope = []) {
    ...
    if (__mfModuleCache.share["default:react"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__inventory__loadShare__react__loadShare__.js-CMbQQlkX.js').then(n => n.R),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["default:react-dom"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__inventory__loadShare__react_mf_2_dom__loadShare__.js-D9KS16vq.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
