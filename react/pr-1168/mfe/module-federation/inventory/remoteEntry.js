import { _ as __vitePreload } from './assets/preload-helper-n8Eyq3iC.js';
...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-Gh0m_h1V.js'),true?[]:void 0))
