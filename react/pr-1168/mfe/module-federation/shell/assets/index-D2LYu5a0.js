...
import { _ as __mf_0 } from './_virtual_mf___mfe_internal__mfe_shell__loadShare__react_mf_2_dom_mf_1_client__loadShare__.js-6t3c58mB.js';
import { _ as __vitePreload } from './preload-helper-DI8TksTD.js';
import './__virtual_mf___mfe_internal__mfe_shell__loadShare__react__loadShare__.js_commonjs-proxy-5Bl1eqRa.js';
import './__virtual_mf___mfe_internal__mfe_shell__loadShare__react_mf_2_dom__loadShare__.js_commonjs-proxy-Cs7GLLGo.js';
import './_virtual_mf___mfe_internal__mfe_shell__loadShare__react_mf_2_dom__loadShare__.js-CF3rrn05.js';
  ...
  return function () {
    ...
    if (Array.isArray(valueOrFn)) {
      return valueOrFn.reduce(function (acc, item) {
        return _objectSpread2$2(_objectSpread2$2({}, acc), sx(item)(props));
      }, {});
    }
...
const WidgetUpdates = createRemote(() => __vitePreload(() => import('./virtual_mf___mfe_internal__mfe_shell__loadRemote__widget_updates_mf_1_main__loadRemote__-Cv4NZb57.js').then(n => n.v),true?[]:void 0).then(function(__mf_m__) {
...
const WidgetOS = createRemote(() => __vitePreload(() => import('./virtual_mf___mfe_internal__mfe_shell__loadRemote__widget_os_mf_1_main__loadRemote__-DWRX7P0C.js').then(n => n.v),true?[]:void 0).then(function(__mf_m__) {
  var __mf_pending__ = __mf_m__ && __mf_m__.__mf_remote_pending;
  var __mf_ready__ = __mf_pending__ && typeof __mf_pending__.then === "function"
    ? __mf_pending__.then(function(__mf_resolved__) { return __mf_resolved__ || __mf_m__; })
    : Promise.resolve(__mf_m__);
...
const InventoryView = createRemote(() => __vitePreload(() => import('./virtual_mf___mfe_internal__mfe_shell__loadRemote__inventory_mf_1_main__loadRemote__-BoJMxuM8.js').then(n => n.v),true?[]:void 0).then(function(__mf_m__) {
  var __mf_pending__ = __mf_m__ && __mf_m__.__mf_remote_pending;
  var __mf_ready__ = __mf_pending__ && typeof __mf_pending__.then === "function"
    ? __mf_pending__.then(function(__mf_resolved__) { return __mf_resolved__ || __mf_m__; })
    : Promise.resolve(__mf_m__);
