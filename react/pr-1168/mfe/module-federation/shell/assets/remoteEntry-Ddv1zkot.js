const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ssrEntryLoader-dDwSIX9h.js","assets/preload-helper-DI8TksTD.js"])))=>i.map(i=>d[i]);
...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./_virtual_mf-localSharedImportMap___mfe_internal__mfe_shell-DxlPRx70.js'),true?[]:void 0))
  ...
  async function init(shared = {}, initScope = []) {
    ...
    if (__mfModuleCache.share["default:react"] === undefined) {
        const mod = await __vitePreload(() => import('./_virtual_mf___mfe_internal__mfe_shell__loadShare__react__loadShare__.js-CvM7R8TO.js').then(n => n.R),true?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["default:react-dom"] === undefined) {
        const mod = await __vitePreload(() => import('./_virtual_mf___mfe_internal__mfe_shell__loadShare__react_mf_2_dom__loadShare__.js-CF3rrn05.js').then(n => n._),true?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
