...
import './remoteEntry-CmTikrVx.js';
...
const WidgetUpdates = createRemote(() => __vitePreload(() => import('./virtual_mf___mfe_internal__mfe_shell__loadRemote__widget_updates_mf_1_main__loadRemote__-BEszIF2l.js').then(n => n.v),true?[]:void 0).then(function(__mf_m__) {
...
const WidgetOS = createRemote(() => __vitePreload(() => import('./virtual_mf___mfe_internal__mfe_shell__loadRemote__widget_os_mf_1_main__loadRemote__-DVJIYLcz.js').then(n => n.v),true?[]:void 0).then(function(__mf_m__) {
  var __mf_pending__ = __mf_m__ && __mf_m__.__mf_remote_pending;
  var __mf_ready__ = __mf_pending__ && typeof __mf_pending__.then === "function"
    ? __mf_pending__.then(function(__mf_resolved__) { return __mf_resolved__ || __mf_m__; })
    : Promise.resolve(__mf_m__);
...
const InventoryView = createRemote(() => __vitePreload(() => import('./virtual_mf___mfe_internal__mfe_shell__loadRemote__inventory_mf_1_main__loadRemote__-CzGZzzky.js').then(n => n.v),true?[]:void 0).then(function(__mf_m__) {
  var __mf_pending__ = __mf_m__ && __mf_m__.__mf_remote_pending;
  var __mf_ready__ = __mf_pending__ && typeof __mf_pending__.then === "function"
    ? __mf_pending__.then(function(__mf_resolved__) { return __mf_resolved__ || __mf_m__; })
    : Promise.resolve(__mf_m__);
