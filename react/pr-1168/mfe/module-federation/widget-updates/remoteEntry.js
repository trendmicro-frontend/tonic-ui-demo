import { _ as __vitePreload } from './assets/preload-helper-Dqveael-.js';
...
for (const __mfShareKey of Object.keys(__mfModuleCache.share)) {
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/_virtual_mf-localSharedImportMap___mfe_internal__widget_updates-YS0otX_3.js'),true?[]:void 0))
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-CejDQjAM.js'),true?[]:void 0))
  ...
  async function init(shared = {}, initScope = []) {
    ...
    if (__mfModuleCache.share["default:react"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__widget_updates__loadShare__react__loadShare__.js-vTp6-9Cn.js').then(n => n.R),true?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["default:react-dom"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__widget_updates__loadShare__react_mf_2_dom__loadShare__.js-DQ0lHTxl.js').then(n => n._),true?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
